# Contribute to the Notion To Unity
...
- GitHub issue, using the bug template. Please check the issue you are reporting is not already listed and follow the template provided to report the issue. (https://github.com/CarterGames/NotionToUnity/issues).
...
- GitHub issue, using the feature template. (https://github.com/CarterGames/NotionToUnity/issues).
- Email (hello@carter.games)


### Code changes
This is the more complicated contribution as you need to follow bigger guides and understanding how the asset functions behind the scenes. While I'm open to code changes, they may take longer to be accepted.
...
- Create a PR merging your changes into the **contribution** branch (https://github.com/CarterGames/NotionToUnity/tree/contribution). Your PR should explain what it adds to the project.
