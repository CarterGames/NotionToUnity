...
namespace CarterGames.NotionData.Editor
{
    public static partial class NotionDataSettingsProvider
    {
        ...
        private static readonly GUIContent VersionValue = new GUIContent(NdAssetVersionData.VersionNumber, "The version you currently have installed.");
        ...
        private static readonly GUIContent ReleaseValue = new GUIContent(NdAssetVersionData.ReleaseDate, "The version you currently have installed.");
