...
namespace CarterGames.NotionData.Editor
{
    public static partial class NotionDataSettingsProvider
    {
        ...
        private const string GithubLink = "https://github.com/CarterGames/NotionToUnity";
        private const string DocsLink = "https://carter.games/notion-database-to-unity-so-standalone/";
